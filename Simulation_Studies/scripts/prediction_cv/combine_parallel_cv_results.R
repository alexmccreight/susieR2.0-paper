# =============================================================================
# Combine Parallel CV Prediction Results — Prediction CV Pipeline
# =============================================================================
# Final stage of the 3-step prediction-CV pipeline (generator -> worker ->
# combiner). Run AFTER all per-rep batches written by
# prediction_cv_script_parallel.R have completed.
#
...
#   Rscript combine_parallel_cv_results.R \
#     pattern='pred_cv_nrep300_sparse_h2persnp0.03_K1_n1000_nfolds5' \
#     input_dir='/home/apm2217/output'
# =============================================================================

#' Combine parallel CV prediction results
#'
...
#'   "pred_cv_nrep300_sparse_h2persnp0.03_K1_n1000_nfolds5". The script
#'   appends `_rep[0-9]+-[0-9]+\.rds$` to find the per-batch files.
...
#'   shared simulation parameters including `n_folds` plus combiner
#'   provenance).
combine_parallel_cv_results <- function(input_dir = NULL,
                                        pattern = NULL,
                                        output_file = NULL,
  ...
  cat("\n========================================\n")
  cat("Combining Parallel CV Prediction Results\n")
  cat("========================================\n")
...
results <- combine_parallel_cv_results()
